...
| **Notify connection** | The one pooled connection dedicated to LISTEN: holds all channel subscriptions and streams NotificationResponse messages continuously; live queries and `listen()` ride it in multi-process mode. |
